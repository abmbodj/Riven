...
export default function HeartsDisplay({ onClick }) {
    ...
    return (
        <button
            onClick={onClick}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-claude-bg/80 backdrop-blur-md border border-red-500/20 rounded-full shadow-sm hover:bg-red-500/5 active:scale-95 transition-all tap-action relative z-10"
        >
