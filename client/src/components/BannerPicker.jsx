...
export default function BannerPicker({ currentBanner, onSelect, onClose }) {
    ...
    const handleFileSelect = (e) => {
        ...
        // Validate file size (max 4MB for banners typically)
        ...
        reader.onload = (event) => {
            ...
            // Resize static images to a larger format (e.g. 1024 width max) since it's a banner
            const img = new Image();
            img.onload = () => {
        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-center p-4 border-b border-claude-border shrink-0">
                    <h3 className="text-lg font-display font-bold">Change Banner</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="w-full relative">
                            <div className="w-full aspect-[3/1] rounded-2xl overflow-hidden bg-claude-bg border-4 border-claude-border shadow-sm md:shadow-lg relative">
                                {loading ? (
                                    ...
                                    <div className="w-full h-full flex flex-col items-center justify-center text-claude-secondary/50">
                        ...
                        <p className="text-xs text-claude-secondary text-center max-w-xs">
                            Upload any image file (JPG, PNG, GIF). Max 4MB. Wide aspect ratio recommended.
                        </p>
                    </div>
                </div>
